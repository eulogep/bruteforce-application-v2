...
var Select = (props) => {
  ...
  const [valueNode, setValueNode] = React30.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React30.useState(false);
  ...
  const triggerPointerDownPosRef = React30.useRef(null);
  const isFormControl = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React30.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime10.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime10.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React30.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React30.useCallback((option) => {
...
var SelectContentImpl = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    const handleItemLeave = React30.useCallback(() => content == null ? void 0 : content.focus(), [content]);
...
var SelectScrollUpButton = React30.forwardRef((props, forwardedRef) => {
...
var SelectScrollDownButton = React30.forwardRef((props, forwardedRef) => {
